...
The notebook uses Anthropic Claude through CrewAI:
...
`define_questions_task` asks the coach agent to generate 10 interview questions using:
...
- Generated questions are parsed from Markdown with regex.
